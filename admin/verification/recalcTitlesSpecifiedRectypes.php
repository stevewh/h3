...
$rt_names = mysqli__select_assoc($mysqli, 'defRecTypes', 'rty_ID', 'rty_Name', 'rty_ID in ('.$recTypeIds.')');

$masks = mysqli__select_assoc($mysqli, 'defRecTypes', 'rty_ID', 'rty_TitleMask', 'rty_ID in ('.$recTypeIds.')');
$updates = array();
$blank_count = 0;
$repair_count = 0;
$processed_count = 0;
