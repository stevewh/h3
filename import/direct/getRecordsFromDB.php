			...
			function doTransfer()
			{
				...
				while ($row1 = mysqli_fetch_array($res1)) {
					...
					while ($row2 = mysqli_fetch_array($res2)) {
						...
						if($is_h2){
							$query3 = "SELECT `rd_type`, `rdt_type`, `rd_val`, `rd_file_id`, ST_AsText(`rd_geo`)
							...
							$query3 = "SELECT `dtl_DetailTypeID`, `dty_Type`, `dtl_Value`, `dtl_UploadedFileID`, ST_AsText(`dtl_Geo`)
