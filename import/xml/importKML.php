...
*/
	...
	function getReferenceTypes() {
		...
		$mysqli = mysqli_connection_select(DATABASE);	// saw TODO check that this is correct seems that it is trying order on non bib types.
		HeuristKMLParser::$_referenceTypes = mysqli__select_assoc($mysqli, "defRecTypes ", "rty_Name", "rty_ID", "rty_ShowInLists = 1 order by rty_RecTypeGroupID = 2, rty_Name");
